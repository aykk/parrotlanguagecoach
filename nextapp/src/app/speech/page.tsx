...
export default function AzureSpeechTest() {
  ...
  const runAssessment = async () => {
    ...
    try {
      ...
      const extractedPhonemeScores = extractPhonemeScores(parsed);
      setPhonemeScores(extractedPhonemeScores);
  ...
  return (
    <div className="min-h-screen p-6 max-w-4xl mx-auto space-y-6">
      ...
      {Object.keys(phonemeScores).length > 0 && (
        <div className="rounded-xl border p-4">
          <h3 className="font-medium mb-3">Phoneme Accuracy Heatmap</h3>
